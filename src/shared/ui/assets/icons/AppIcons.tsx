...
export const BarsIcon: React.FC<IconProps> = ({ className, onClick }) => {
  return (
    <svg
      className={className}
      onClick={onClick}
...
export const UserCircleIcon: React.FC<IconProps> = ({ className, onClick }) => {
  return (
    <svg
      className={className}
      onClick={onClick}
...
export const UploadFileIcon: React.FC<IconProps> = ({ className, onClick }) => {
  return (
    <svg
      onClick={onClick}
      className={className}
...
export const DownloadFileIcon = ({ className, onClick }: IconProps) => {
  return (
    <svg
      className={className}
      onClick={onClick}
...
export const CloseCircleIcon = ({ className, onClick }: IconProps) => {
  return (
    <svg
      onClick={onClick}
      className={className}
...
export const ConfigIcon: React.FC<IconProps> = ({ className, onClick }) => {
  return (
    <svg
      onClick={onClick}
      className={className}
